...
| <a name="input_name"></a> [name](#input\_name) | (Required) Specifies the name of the EventHub Cluster resource. Changing this forces a new resource to be created. | `string` | n/a | yes |
...
| <a name="input_sku_name"></a> [sku\_name](#input\_sku\_name) | (Required) The sku name of the EventHub Cluster. The only supported value at this time is Dedicated\_1. | `string` | `"Dedicated_1"` | no |
