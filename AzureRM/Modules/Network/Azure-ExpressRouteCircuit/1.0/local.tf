...
locals {
  express_route_port_id = var.express_route_port.id == null ? (
    var.express_route_port.name == null ? (
      var.express_route_ports[var.express_route_port.tag].id
    ) : "/subscriptions/${local.subscription_id}/resourceGroups/${var.express_route_port.resource_group_name == null ? local.resource_group_name : var.express_route_port.resource_group_name}/providers/Microsoft.Network/expressRoutePorts/${var.express_route_port.name}"
  ) : var.express_route_port.id
