...
| Name | Type |
|------|------|
| [azurerm_route_filter.this](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/route_filter) | resource |
...
| <a name="input_rule"></a> [rule](#input\_rule) | n/a | <pre>object({<br>    name        = string #  (Required) The name of the route filter rule.<br>    rule_type   = string #  (Required) The rule type of the rule. The only possible value is Community.<br>    communities = string #  (Required) The collection for bgp community values to filter on. e.g. ['12076:5010','12076:5020'].<br>    access      = string #  (Required) The access type of the rule. The only possible value is Allow.<br>  })</pre> | n/a | yes |
