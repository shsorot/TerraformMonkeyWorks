...
|------|-------------|------|---------|:--------:|
| <a name="input_cidrs"></a> [cidrs](#input\_cidrs) | (Required) Vnet/subnet CIDRs of the IP Group to be created | `list(string)` | `null` | no |
...
| <a name="input_location"></a> [location](#input\_location) | (Required) Location of the resource 'IP Group' to be created. | `any` | `null` | no |
| <a name="input_name"></a> [name](#input\_name) | (Required) Name of the IP Group to be created | `any` | n/a | yes |
...
| <a name="input_tags"></a> [tags](#input\_tags) | (Required) Tags of the IP Group to be created | `map` | `{}` | no |

## Outputs

| Name | Description |
|------|-------------|
| <a name="output_id"></a> [id](#output\_id) | Id of the IP Group. Can be passed to Firewall rule/s collection. |
<!-- END_TF_DOCS -->