...
| <a name="input_record"></a> [record](#input\_record) | (Required) The target of the CNAME. | <pre>list(object({<br>    priority = number<br>    weight   = number<br>    port     = number<br>    target   = string<br>  }))</pre> | n/a | yes |
