...
data "azurerm_key_vault" "this" {
  count               = var.key_vault_key.key_vault_name == null ? 0 : 1
  name                = var.key_vault_key.key_vault_name
  resource_group_name = coalesce(var.key_vault_key.resource_group_name, local.resource_group_name)
}

data "azurerm_key_vault_key" "this" {
  count        = var.key_vault_key.name == null && var.key_vault_key.resource_group_name == null ? 0 : 1
