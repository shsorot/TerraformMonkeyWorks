...
| <a name="input_name"></a> [name](#input\_name) | (Required) Specifies the name of the availability set. Changing this forces a new resource to be created | `string` | n/a | yes |
