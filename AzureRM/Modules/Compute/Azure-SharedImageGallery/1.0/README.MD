...
|------|-------------|------|---------|:--------:|
| <a name="input_description"></a> [description](#input\_description) | (Required) Specifies the supported Azure location where the resource exists. <br>    Changing this forces a new resource to be created. | `string` | n/a | yes |
...
| <a name="input_name"></a> [name](#input\_name) | (Required) Specifies the name of the Shared Image Gallery. <br>  Changing this forces a new resource to be created. | `string` | n/a | yes |
...
| <a name="input_tags"></a> [tags](#input\_tags) | (Optional) A mapping of tags which should be assigned to the Shared Image Gallery. | `map(string)` | `{}` | no |
...
| <a name="output_unique_name"></a> [unique\_name](#output\_unique\_name) | n/a |
<!-- END_TF_DOCS -->