...
locals {
  ...
  # network-tags        =   merge(var.tags,( var.inherit_tags == true ? data.azurerm_resource_group.vnet-rg.tag : {} ))
  # vm-tags             =   merge(var.tags,( var.inherit_tags == true ? data.azurerm_resource_group.vm-rg.tag : {} ))
  ...
  external-load-balancer-id                               = var.untrusted-external-loadbalancer.id == null ? var.loadbalancers[var.untrusted-external-loadbalancer.key].id : var.untrusted-external-loadbalancer.id
  internal-load-balancer-id                               = var.untrusted-internal-loadbalancer.id == null ? var.loadbalancers[var.untrusted-internal-loadbalancer.key].id : var.untrusted-internal-loadbalancer.id
